...
<body>
	...
	<div class="container-fluid">
		...
		<h3 class="text-success text-center">
			<%
			if (request.getSession().getAttribute("update_status") != null) {

				out.println(request.getSession().getAttribute("update_status"));
				request.getSession().setAttribute("update_status", null);
		...
		<form class="w-50 m-4 shadow p-4 mx-auto" id="resume-form" enctype="multipart/form-data" method="post">
			...
			<div class="mb-3 mx-auto text-center">
				<button class="btn btn-danger text-center btn-block"
					formaction="EditResumePage" id="resume-form" type="submit">
